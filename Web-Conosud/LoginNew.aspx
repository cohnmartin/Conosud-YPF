<%@ Page Language="C#" Theme="MiTema" AutoEventWireup="true" CodeFile="LoginNew.aspx.cs"
    Inherits="LoginNew" %>
...
<head runat="server">
    ...
    <style type="text/css">
        body {
            ...
            background-image: url('images/Fondo_new.jpg');
...
<body style="background-color: #E4E4E4; margin-top: 2px">
    <form id="Form1" method="post" runat="server">
        ...
        <div class="login-wrap">
            <div class="login-html">
                <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">INGRESO A SCS</label>
                ...
                <div class="login-form">
                    <div class="sign-in-htm">
                        ...
                        <div class="group">
                            <input type="submit" class="button" value="INGRESAR" onclick="EjecutarLogin()">
                        </div>
                        <div class="hr"></div>
                    </div>
    ...
    <script type="text/javascript">
        function EjecutarLogin() {
            ...
            PageMethods.Login($('#user').val(), $('#pass').val(),
                function (result) {
                    if (result!='')
                        alert(result);
                    else
                ...
                function () {
                    alert("Error de Login, por favor tome contacto con el administrador.");
                });

<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.master" AutoEventWireup="true"
    CodeFile="PruebaBusquedaDirecciones.aspx.cs" Inherits="PruebaBusquedaDirecciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="type-selector" class="controls">
     ...
     <div id="map-canvas" style="height: 400px; width: 970px; margin-bottom: 5px; position: relative;
        top: 0px; float: left">
    </div>

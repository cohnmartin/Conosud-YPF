...
//                        }
        ...
        function IrPaso2() {
            ...
            minDistance = 10000;
            PageMethods.BuscarLineaTransporte(ubicacionOrigen.lat(), ubicacionOrigen.lng(), $('#cboTurno').val(), BuscarPuntoMasCercano, ErrorBusqueda);
...
//            }
            ...
            calcularPuntoMasCercano(destinosPosibles, ubicacionOrigen).then(function (result) {
                ...
                if (datos["RutaAlt"] != undefined) {
                    // Caclulos para el recorrido de Regreso
                    destinosPosibles = new Array();
                    for (var i = 0; i < datos["PuntosCercanosAlt"].length; i++) {
                        destinosPosibles.push(new google.maps.LatLng(datos["PuntosCercanosAlt"][i].Key, datos["PuntosCercanosAlt"][i].Value));
                    }
                    calcularPuntoMasCercano(destinosPosibles, ubicacionOrigen).then(function (result) {
                        datosRegreso = result;
        ...
        function calcularPuntoMasCercano(destinosPosibles, origin) {
                        ...
                        for (var i = 0; i < origins.length; i++) {
                            ...
                            for (var j = 0; j < results.length; j++) {
                                ...
                                if (results[j].distance != null && results[j].distance.value < minDistance) {
                                    objResultado.pointMin = porsion[j];
                                    objResultado.minDistance = results[j].distance.value;
                                    objResultado.descDistancia = results[j].distance.text;
                                    objResultado.descDuracion = results[j].duration.text;
                                    objResultado.destinoMin = destinations[j];
                                }
                            }
                        }


                        dfd.resolve(objResultado);
                    }
                    else {
                        //alert(status)
                    }
    ...
    <div id="divPaso1">
        ...
        <div id="DivDescripcionPto" style="display: none;">
            <table border="0" cellpadding="0" cellspacing="0" style="text-align: left; padding: 2px;
                width: 98%; background-color: White; border: 1px solid black">
                <tr>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" style="text-align: left; padding: 5px;
                            width: 100%; background-color: #99FF99; border: 2px solid #33CC33;" id="tblRecorridoIda">
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label6" runat="server" SkinID="lblConosud" Text="Salida/Llegada:"></asp:Label>
                                </td>
                                <td>
                    ...
                    <td id="tdTableAlt">
                        <table border="0" cellpadding="0" cellspacing="0" style="text-align: left; padding: 5px;
                            width: 100%; background-color: #6699FF; border: 2px solid #0033CC;">
                            <tr>
                                <td colspan="4" align="center">
                                    <asp:Label ID="lblLineaAlt" runat="server" SkinID="lblConosud" Text="Nro 2 (SAN JOSE - DORREGO)"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label20" runat="server" SkinID="lblConosud" Text="Horario Salida/Llegada:"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lblHorariosAlt" runat="server" SkinID="lblConosudNormal" Text="6.1/7.45 - 18.05/19.15"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label18" runat="server" SkinID="lblConosud" Text="Turno:"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr style="display: none">
                                ...
                                <td>
                                    <asp:Label ID="lblDistanciaAlt" runat="server" SkinID="lblConosudNormal" Text=""></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label30" runat="server" SkinID="lblConosud" Text="Duración:"></asp:Label>
                                </td>
                                <td>

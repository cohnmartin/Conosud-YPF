    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            google.maps.event.addListener(map, 'click', function (event) {
                ...
                $("#newPoints").val($("#newPoints").val() + '{ "Geometry" :{"Latitude":' + event.latLng.lat() + ', "Longitude":' + event.latLng.lng() + '}},');
        ...
        function init(star, end, newPoints) {
            ...
            if (star != null) {
                ...
                if (parseInt(star) > parseInt(end)) {
                    puntoDesde = end;
                    puntoHasta = star;
                    //newPoints = eval('{' + $('#newPoints').val() + '}');
                    //newPoints.reverse();
                }
                eval('stops.splice(' + puntoDesde + ', ' + puntoHasta + ', ' + newPoints + ')');
                //stops.splice(puntoDesde, puntoHasta, newPoints)
            }
